...
\begin{center}
\emph{Survival is determined by task-conditional marginal economic productivity per standardized unit of compute. A competitive prediction market pays exactly that margin, so average PnL per token ranks task-level productivity at a common shadow price of compute, and degrades insofar as deployment is administered or scarcity regimes are mixed.}
\end{center}

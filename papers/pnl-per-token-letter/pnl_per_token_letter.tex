...
\label{lem:ap}
Take $\phi(z) = \log(1+z)$ and the water-filling allocation \eqref{eq:waterfill}. A model serving a task with productivity $\theta > \lambda$ earns average PnL per token
\begin{equation}
